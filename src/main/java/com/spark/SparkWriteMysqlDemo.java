...
public class SparkWriteMysqlDemo {
    public static void main(String[] args){
        ...
        JavaRDD<String> personData = sparkContext.parallelize(Arrays.asList("1 tom 5", "2 jim 6", "3 hh 9", "4 zz 10", "5 yy 20"));
        ...
        persistDF.write().mode("append").jdbc("jdbc:mysql://x.x.x.x:3306/dbname","PERSON_INFO",connectionProperties);
    }
}
